// src/pages/Subjects/components/SubjectForm.jsx
...
const SubjectForm = ({
  ...
  // Reset form khi mở/đóng hoặc khi editingSubject thay đổi
  useEffect(() => {
    if (editingSubject) {
      setFormData({
          ...
          <div className="grid gap-4 py-4">
              ...
              <div className="col-span-3">
                ...
                {errors.subjectCode ? (
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Tùy chọn. Tối đa 10 ký tự in hoa và số
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                ...
                />
                <p className="text-sm text-muted-foreground mt-1">
                  Tùy chọn. Mô tả về nội dung môn học
                </p>
              </div>
            </div>
